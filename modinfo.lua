...
meta =
{
    ...
    title = "Galaxy Map Paper Trail",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Shows a trail of the last locations you have been to on the galaxy map",
    ...
    contact = "Discord: riandrake#6840",
}
